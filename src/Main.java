                ...
                for (int i = 0; i < heroesHealth.length - 1; i++) {
                    if(heroesHealth[i] < 100 && heroesHealth[i] > 0 && heroesHealth[heroesHealth.length - 1] > 0){
                        ...
                        for (int j = 0; j < heroesHealth.length - 1; j++) {
                            if(heroesHealth[j] < min && heroesHealth[i] > 0){
                                min = heroesHealth[j];
                                minIndex = j;
                            }
                        }
                        heroesHealth[minIndex] = heroesHealth[minIndex] + randomHealth.nextInt(60);
                        System.out.println("Added health " + heroesHealth[minIndex]);
                        break;
                    }
                }
            }
